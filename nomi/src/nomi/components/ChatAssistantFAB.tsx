...
import novaLogo from "../../assets/Nomi_Logo_Groß.png";
    ...
    <>
      <style>{`
        ...
        .ai-status-indicator {
          ...
          box-shadow: 0 0 8px rgba(63, 178, 146, 0.6);
          z-index: 2;
        ...
        @keyframes status-pulse {
          ...
          50% {
            opacity: 0.7;
            box-shadow: 0 0 12px rgba(63, 178, 146, 0.8);
          }
        }
      `}</style>
      ...
      <button
        ...
        title="Fragen Sie unseren KI-Assistenten NOMI - KI aktiv ✨"
      >
        <div className="ai-status-indicator" title="KI online"></div>
